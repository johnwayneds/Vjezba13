<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			# dodan kod
			$_SESSION['vijest1'] = "US growth faster than expected";
			...
			# dodan kod
			$_SESSION['vijest2'] = "Wall Street: Tech firm surge pushes US markets higher";
			print '
			...
			# dodan kod
			$_SESSION['vijest3'] = "Hotel booking sites probed by consumer watchdog";
			print '
